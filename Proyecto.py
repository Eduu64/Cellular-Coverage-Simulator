...
class SIM():
    ...
    LS1 = [(0, 0), (30, 0), (60, 3), (90, 10),(120, 25), (150, 27), (180, 27), (210, 25), (240, 20), (270, 10),(300, 3), (330, 0)]
    ...
    def CalcularPds(self):
        ...
        for angulo,resultado in self.GTXS1:
            ...
            while top == False :
                ...
                if aux < self.Smax:
                    top = True
                    auxLat = (self.LAT+(math.sin(angulo)*d)/111320)
                    auxLon =  (self.LON+(math.cos(angulo)*d)/111320)
                    self.Pd.append((angulo,auxLat,auxLon,aux))
