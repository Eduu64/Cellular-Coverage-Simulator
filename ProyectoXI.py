...
def calcular():
    try:
        ...
        # Imprimir todos los valores capturados
        print("Valores capturados:")
        print(f"LON: {value1}")
        print(f"LAT: {value2}")
        print(f"PTX: {value3}")
        print(f"GTXdBi: {value4}")
        print(f"LTX: {value5}")
        print(f"LRX: {value6}")
        print(f"GRX: {value7}")
        print(f"Frec: {value8}")
        print(f"Hb: {value9}")
        print(f"Hm: {value10}")
        print(f"Steps: {value11}")
        print(f"Smax: {value12}")
        ...
        sim = SIM(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11, value12, value13, value14)
...
window, map_widget, Entry_id1, Entry_id2, Entry_id3, Entry_id13, Entry_id15, Entry_id16, Entry_id17, Entry_id21, Entry_id23, Entry_id24, Entry_id27, Entry_id29, desplegable, Entry_id30, Entry_id31 = create_gui(calcular)
window.mainloop()